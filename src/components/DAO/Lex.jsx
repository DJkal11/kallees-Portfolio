...
function Raid() {
  return (
    <div className="transitionPage h-screen fixed text-center insight text-white DAO-mobile">
      ...
      <button className="hover:bg-white hover:text-black border-2 border-white rounded-lg p-2 ml-5">
        View Bank
      </button>
      <Link to="/LexProposal">
        <button className="hover:bg-gray-500 bg-gray-400 border-2 border-gray-400 rounded-lg p-2 ml-2 text-white">
          View Proposals
        </button>
      </Link>
    </div>
