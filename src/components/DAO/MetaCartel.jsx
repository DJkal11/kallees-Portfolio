  ...
  return (
    <div className="transitionPage h-screen fixed insight text-white DAO-mobile">
      ...
      <div className="text-center">
        <button className="hover:bg-white hover:text-black border-2 border-white p-2 ml-5 rounded-lg">
          View Bank
        </button>
        <Link to="/MetaCartelProposal">
          <button className="hover:bg-purple-500 bg-purple-400 border-2 border-purple-400 p-2 ml-2 rounded-lg text-white">
            View Proposals
          </button>
        </Link>
      </div>
