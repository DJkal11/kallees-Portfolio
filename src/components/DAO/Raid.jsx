...
function Raid() {
  return (
    <div className="transitionPage h-screen fixed text-center pl-20 pr-20 insight text-white DAO-mobile">
      ...
      <div className="text-center">
        ...
        <Link to="/RaidProposal">
          <button className="hover:bg-red-500 bg-red-400 border-2 border-red-400 p-2 rounded-lg ml-2 text-white">
            View Proposals
          </button>
        </Link>
      </div>
