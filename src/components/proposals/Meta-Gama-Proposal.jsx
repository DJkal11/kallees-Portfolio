    ...
    return (
        <div className=" transitionProposal max-w-screen-2xl h-screen height-mobile margin-mobile bg-red-400 margin text-white" style={{backgroundImage: "url(https://images.unsplash.com/photo-1629984164142-21c2039de926?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80)", backgroundSize: "cover"}}>
            ...
            <div className="grid grid-cols-2 welcome">
             ...
             <div className="shadow-2xl w-9/12 m-10 mb-5 mr-0 rounded-3xl bg-pink-500 bg-opacity-50">
         
         <div className="p-10 pt-2">
             <div className="">
               <h1 className="text-3xl">MEMBER PROPOSAL</h1>
               <h1 className="text-lg">mantherthepanther#2373 / The Manther (Telegram)</h1>
        ...
        <div className=" bg-pink-500 bg-opacity-50 w-9/12 m-10  mb-5 mr-0 h-auto rounded-3xl">

         <div className="p-10 pt-2 shadow-2xl rounded-3xl">
             <div className="">
               <h1 className="text-3xl">MEMBER PROPOSAL</h1>
               <h1 className="text-lg">interested in this project</h1>
               <h2 className="text-lg">interested in more women joining the cryptospace.</h2>
        ...
        <div className=" bg-pink-500 bg-opacity-50 w-9/12 m-10 mb-5 mr-0 rounded-3xl">
