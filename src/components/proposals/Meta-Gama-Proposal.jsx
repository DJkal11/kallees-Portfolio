  ...
  return (
    ...
    >
      ...
      <Link to="/">
        ...
        <div className="p-10 pt-2 pb-2 mt-10">
      ...
      <div className="grid grid-cols-2 welcome pl-44 pr-36 proposal-padding-mobile proposal-padding-tablet">
        ...
        <div className="shadow-2xl w-80 h-auto m-10 mb-7 mr-0 rounded-3xl colour text-white">
          <div className="p-8">
            <div className="">
              ...
              <h1 className="text-3xl">mantherthepanther Token</h1>
              <h3 className="text-2xl">Submitted Nov 14,2021</h3>
        ...
        <div className="w-80 h-auto m-10 mb-7 mr-0 rounded-3xl colour text-white">
          <div className="p-8">
            <div className="">
              ...
              <h1 className="text-xl">Payment Requested</h1>
            </div>
          </div>
        </div>
        ...
        <div className="w-80 h-auto m-10 mb-7 mr-0 rounded-3xl colour text-white">
          <div className="p-8">
            <div className="">
              <h1 className="text-4xl">MEMBER PROPOSAL</h1>
              <h2 className="text-3xl">Membership Proposal</h2>
              <h3 className="text-2xl">Submitted Nov 24,2021</h3>
              <h1 className="text-xl">Unsponsored</h1>
            </div>
          </div>
