...
function MetaCartelProposal() {
    ...
    return (
        <div className="transitionProposal max-w-screen-2xl h-screen height-mobile bg-red-400 margin margin-mobile text-white" style={{backgroundImage: "url(https://images.unsplash.com/photo-1629984164142-21c2039de926?ixlib=rb-1.2.1&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1740&q=80)", backgroundSize: "cover"}}>
